...
parser.add_argument('-f', type=str, help='This is the source file of domains', default='PROJ3-HNS.txt',action='store', dest='in_file')
parser.add_argument('-o', type=str, help='This is the destination file for IP addresses', default='RESOLVED.txt',action='store', dest='out_file')
